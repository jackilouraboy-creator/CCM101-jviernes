...
|---|---|---|---|
| Compute | EC2 (Elastic Compute Cloud) | Virtual Machines (Azure VMs) | Compute Engine |
...
| Identity and Access Management (IAM) | AWS IAM | Microsoft Entra ID (formerly Azure AD) and Azure RBAC | Cloud IAM |
